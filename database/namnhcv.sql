...
--
-- Host: localhost
-- Generation Time: Aug 17, 2017 at 01:31 PM
...
-- Database: `namnhcv`
--
CREATE DATABASE IF NOT EXISTS `namnhcv` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `namnhcv`;
...
(4, 'application/pdf', 'CV_NAMNH_ENG_VN.pdf', '2017-08-14 16:36:00', '2017-08-14 16:36:00'),
(5, 'application/pdf', 'NAM_NH_CV_PHP_DEVELOPER_ENG_VI.pdf', '2017-08-15 02:59:31', '2017-08-15 02:59:31');
...
(1, '05/2016', '08/2017', 'Nhan Hoa Software Company Limited', 'Head Of Representative Office', '- Managed and developed market at all of services : Domain, Website, \nVPS, Server and Reseller.<br>\n- Allocated staff, assigned personnel tasks, take responsibility for team.<br>\n- Designed, coded and installed website.', 'Mr Nguyễn Văn Hoàn', '0985 566 672', 0, '2017-08-10 17:44:36', '2017-08-10 17:44:36'),
(2, '03/2016', '05/2016', 'VNG Corporation', 'Team Leader', '- Searched, planned, surveyed about OTT Market Survey Project 2016\n of Zalo in Da Nang.<br>\n- Recruitmented, guided, trained skills for teammate.\n', 'Mr Nguyễn Tiến Hữu', '0902 718 450', 1, '2017-08-10 17:46:08', '2017-08-10 17:46:08'),
(3, '12/2015', '02/2016', 'Autogrill VFS F&B Company', 'Food Service Crew', '- Bartender.<br>\n- Guided, introduced and serviced customters.<br>', 'Mrs Nguyễn Thị Thu Thủy', '0905 650 815', 0, '2017-08-10 17:49:45', '2017-08-10 17:49:45'),
(4, '07/2015', '10/2015', 'Bien Binh Joint Stock Company', 'Content Leader', '- Making planned, managed content, images, events on Fanpage.<br>\n- Gave an ideas, content cencorship, images from design department.<br>\n- Making reported, analysted about Fanpage.', 'Mr Phan Thanh Bình', '0988 551 345', 1, '2017-08-10 17:55:18', '2017-08-10 17:55:18'),
(5, '04/2015', '05/2012', 'VNG Corporation', 'Forum Moderator', '- Managed, accepted, edited content form users.<br>\n- Planned, writted guideline, shared experiment, created subject to discuss.', 'Mr Nguyễn Hữu Trí', '0961 964 018', 0, '2017-08-10 18:01:36', '2017-08-10 18:01:36');
...
('root', '[{"db":"namnhcv","table":"work_experiences"},{"db":"namnhcv","table":"education_experiences"},{"db":"namnhcv","table":"users"},{"db":"namnhcv","table":"migrations"}]');
...
('root', '2017-08-09 10:44:01', '{"collation_connection":"utf8mb4_unicode_ci"}');
