...
<head>
	...
	<!-- Icon Fonts -->
	<link rel="stylesheet" type="text/css" href="asset/frontend/fonts/map-icons/css/map-icons.min.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/fonts/icomoon/style.css">

	<!-- Styles -->
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.bxslider/jquery.bxslider.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.customscroll/jquery.mCustomScrollbar.min.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.mediaelement/mediaelementplayer.min.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.fancybox/jquery.fancybox.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.owlcarousel/owl.carousel.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.owlcarousel/owl.theme.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/js/plugins/jquery.optionpanel/option-panel.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/style.css">
	<link rel="stylesheet" type="text/css" href="asset/frontend/colors/theme-color.css">
	...
	<script type="text/javascript" src="asset/frontend/js/libs/modernizr.js"></script>
	...
	<div class="widget-area">
		<aside class="widget widget-profile">
			<div class="profile-photo">
				<img src="asset/frontend/img/uploads/rs-photo-v2.jpg" alt="Robert Smith" />
			</div>
			...
			<ul>
				<li>
					<div class="post-media">
						<a href=""><img src="asset/frontend/img/uploads/thumb-78x56-1.jpg" alt="" /></a>
					</div>
				...
				<li>
					<div class="post-media">
						<a href=""><img src="asset/frontend/img/uploads/thumb-78x56-2.jpg" alt="" /></a>
					</div>
					<h3 class="post-title"><a href="">Standard Post Format With Featured Image</a></h3>
					<div class="post-info"><a href=""><i class="rsicon rsicon-comments"></i>56 comments</a></div>
				</li>
				<li>
					<div class="post-media">
						<a href=""><img src="asset/frontend/img/uploads/thumb-78x56-3.jpg" alt="" /></a>
					</div>
					<h3 class="post-title"><a href="">Standard Post Format With Featured Image</a></h3>
					<div class="post-info"><a href=""><i class="rsicon rsicon-comments"></i>56 comments</a></div>
				</li>
...
<div class="wrapper">
	<header class="header">
		<div class="head-bg" style="background-image: url('asset/frontend/img/uploads/rs-cover.jpg')"></div>
		...
		<div class="container">
				...
				<div class="animate-up">
					<div class="section-box">
						<div class="profile">
							<div class="row">
								<div class="col-xs-5">
									<div class="profile-photo"><img src="asset/frontend/img/uploads/rs-photo-v1.jpg" alt="Robert Smith" /></div>
								</div>
								<div class="col-xs-7">
									<div class="profile-info">
					...
					<div class="section-txt-btn">
						...
						<p>Hello! I’m Robert Smith. Senior Web Developer specializing in front end development. Experienced with all stages of the development cycle for dynamic web projects. Well-versed in numerous programming languages including JavaScript,
					...
					<div class="section-box">
						<ul class="ref-slider">
							...
							<li>
								<div class="ref-box">
									<div class="person-speech">
										<p>I have known Robert Smith for 10 years as web developer. I can confirm that he is a man of great integrity, is extremely dedicated to his family and work, and is entirely peace-loving.</p>
									</div>
									<div class="person-info clearfix">
										<img class="person-img" src="asset/frontend/img/uploads/rs-avatar-60x60.jpg" alt="Headshot">
										<div class="person-name-title">
			...
			<section id="text-section" class="section section-text">
				<div class="animate-up animated">
					...
					<div class="section-box">
						<p>Hello! I’m Robert Smith and this is custom editor section. You can add here any text or "Strikethrough" text and even you can add bulleted or numbered text and even you will be able to add blockquot text. You can align this
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKgydlTDVNzwQoHNpzydyipQm_qkzdhiI"></script>
